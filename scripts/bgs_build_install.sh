source /mnt/e/SyncData/paper2_main/.venv/bin/python
# cd /home/ha/dev
# git clone --recurse-submodules https://github.com/andrewssobral/bgslibrary.git
cd /home/ha/dev/bgslibrary
rm -rf build # Clear previous build to avoid cache issues
mkdir build && cd build
cmake .. \
	-DPYTHON_EXECUTABLE=/mnt/e/SyncData/paper2_main/.venv/bin/python \
	-DBGS_CORE_STATIC=ON \
	...
	-DCMAKE_INSTALL_PREFIX=/mnt/e/SyncData/paper2_main/.venv
make -j8
make install
