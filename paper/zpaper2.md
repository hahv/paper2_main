...
- **Comprehensive System Evaluation and Analysis:** The proposed framework is
  ...
  baseline, with a recall reduction of less than 0.05% when the Eager mode is
  active — compared to a 1.24% recall drop when the skip module is used alone —
...
the cost of a 1.24% reduction in recall, which is likely attributable to missed
...
decreases from $34.93\%$ to $34.21\%$, and the false alarm rate (FAR) increases
