...
%	\cortext[cor1]{Corresponding author}
	...
	\author[1]{Van-Ha Hoang}[orcid=0000-0001-6248-4539]
	\ead{hahv@sju.ac.kr}

	\credit{Writing - original draft, Data curation, Conceptualization, Methodology, Investigation, Formal analysis, Software, Visualization}
	
	\author[2]{Jong Weon Lee}
	\ead{jwlee@sejong.ac.kr}
	\credit{Writing - review \& editing, Supervision, Funding acquisition}

	\author[3]{Goo-Rak Kwon}
	\ead{grkwon@chosun.ac.kr}
	\credit{Review, Funding acquisition}

	\author[4]{Chun-Su Park}[orcid=0000-0003-4250-2597]
	\cormark[1]
	\ead{cspk@skku.edu}
	\credit{Writing - review \& editing, Conceptualization, Methodology, Formal
		analysis, Resources, Supervision, Project administration, Funding acquisition}
		
	
	\affiliation[1]{organization={Department of Software, Sejong University},
		city={Seoul},
		postcode={05006},
		country={South Korea}}
	
	\affiliation[2]{organization={Department of Software, Sejong University},
		city={Seoul},
		postcode={05006},
		country={South Korea}}
	
	\affiliation[3]{organization={Department of Information and Communication Engineering, Chosun University},
		city={Gwangju},
		postcode={61452},
		country={South Korea}}
	
	\affiliation[4]{organization={Department of Computer Education, Sungkyunkwan University},
		city={Seoul},
		postcode={03063},
		country={South Korea}}
	
	\cortext[cor1]{Corresponding author: Chun-Su Park (e-mail: cspk@skku.edu).}
	...
	% Republic of Korea, under Grant RS-2025-23323861. This research was supported
	% by the Technology Development Program (RS-2025-25439892) funded by the
	% Ministry of SMEs and Startups (MSS, Republic of Korea). This research was
	% supported by the MSIT, Korea, under the
	% Graduate School of Virtual Convergence support
	% program(IITP-2026-RS-2023-00254129) supervised by the IITP(Institute for
	% Information \& Communications Technology Planning \& Evaluation). This
	% research was supported by the ANCHOR through the Seoul ANCHOR Center, funded
	% by the Ministry of Education (MOE) and the Seoul Metropolitan Government
	% (2026-ANCHOR-01-018-05). This work was supported by the IITP(Institute of Information \&
	% Communications Technology Planning \& Evaluation)-ITRC(Information
	% Technology Research Center) grant funded by the Korea Government (Ministry of
	% Science and ICT)(IITP-2026-RS-2022-00156354).
...
\bio{figs/authors/a3}
Goo-Rak Kwon (Senior Member, IEEE) received the Ph.D. degree from the Department of Mechatronic Engineering, Korea University, in 2007. He was the Chief Executive Officer and the Director of Dali Tech Company Ltd., from 2004 to 2007. He joined the Department of Electronic Engineering, Korea University, from 2007 to 2008, where he was a Postdoc toral Researcher supporting the BK21 Information Technique Business. He has been a Professor with Chosun University, since 2017. His research interests include medical image analysis, A/V signal processing, video communication, and applications. He was a life member of KMMS,KICS, and KING.
\endbio
...
Sejong University. In 2017, he joined the Department of Computer Education, Sungkyunkwan University, where he is currently a Professor. His research interests include intelligent vision and AI software.
