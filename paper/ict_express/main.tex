...
from the Korea AI Fire Dataset \citep{AIHub87:online}, the USTC Smoke
Dataset \citep{lin2017smoke}, and the VDS3 Dataset \citep{huang2022fire},
...
Safe \& Unsafe Behavior in Workplaces dataset \citep{onal2024video}, the
Indoor Action dataset \citep{deniz2024optimized}, the MPII Cooking 2
Dataset \citep{rohrbach2016recognizing}, and the WiseNet dataset
...
grid search on the D-Fire dataset \citep{dfiredataset}.
...
%% =====================================================================
%% Author biographies. The original A.tex used cas-dc's \bio{...}\endbio
%% environment (image + biography paragraph). elsarticle/ICT Express has
%% no equivalent macro, so each biography is reproduced here as a
%% minipage with the author photo alongside the biography text, keeping
