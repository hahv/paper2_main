...
%	\cortext[cor1]{Corresponding author}
	...
	\title[mode=title]{Efficient Real-Time Fire Surveillance: A Lightweight
		...
		Environments}
	\tnotemark[1]
	\tnotetext[1]{This work was supported by the Technology Development
		Program through the Korean Ministry of Small and Medium Enterprises
		(SMEs) and Startups under Grant S3147433. This research was supported
		by the MSIT (Ministry of Science and ICT), Korea, under the ITRC
		(Information Technology Research Center) support program
		(IITP-2022-RS-2022-00156354) supervised by the IITP (Institute for
