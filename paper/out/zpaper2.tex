...
\subsection{Baseline Models and and Implementation
Details}\label{baseline-models-and-and-implementation-details}
...
\item
  \textbf{BIG Model}: The BIG model is obtained by fine-tuning a
  pretrained High-Performance GPU Network v2 (HGNetV2), specifically the
  \texttt{hgnetv2\_b5.ssld\_stage2\_ft\_in1k} checkpoint
  \citeproc{ref-hgnetv2timm:online}{{[}34{]}} from the Timm library
  \citeproc{ref-rw2019timm}{{[}35{]}}, which was originally trained
  using SSLD knowledge distillation
  \citeproc{ref-cui2021beyond}{{[}36{]}}. HGNetV2
  \citeproc{ref-hgnetv2PaddleCl7:online}{{[}37{]}} is a high-capacity
  CNN architecture designed to achieve substantially higher accuracy
  than models of comparable inference speed on NVIDIA GPUs, making it
...
configuration \(\theta_1^*\) satisfies the recall constraint and
achieves the highest composite score by jointly balancing skip ratio,
false alarm reduction, and recall retention.
