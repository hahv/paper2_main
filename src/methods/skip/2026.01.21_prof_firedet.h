...
public:
    ...
    //for single frame
    bool runModel(FDRecord& fdRcd, Mat& frame, int vchID, int& detectedClassID);
    bool runModelSingle(FDRecord& fdRcd, Mat& frame, int vchID, Rect roi, int& detectedClassID);
};
